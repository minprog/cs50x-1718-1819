...
If among those "more comfortable" with programming, you might choose to  link:/problems/crack[crack some passwords] instead!
...
[source]
----
check50 --local cs50/2018/spring/vigenere
----
