...
And finally, you may use the commands in this link:/course/problems/adventure/win.txt[text file] to single out spots where the checks may not give you enough information to proceed.
