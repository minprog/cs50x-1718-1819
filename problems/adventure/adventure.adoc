...
Besides moving and looking there is also interaction with items. These items are located within room and are yours to take and drop (TAKE <obj>, DROP <obj>).
...
SmallRooms.txt and SmallObjects is a tad bit larger and includes, obviously, items.
