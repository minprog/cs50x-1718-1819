...
```
check50 minprog/cs50x/master/adventure/check50/tiny
check50 minprog/cs50x/master/adventure/check50/small
check50 minprog/cs50x/master/adventure/check50/crowther
```
