...
Although we would normally expect you to choose this version of the problem, aimed at "less comfortable" students, you may choose to do link:/problems/cash[cash], intended for "more comfortable" students, instead!
