...
Although we would normally expect you to choose this version of the problem, aimed at "less comfortable" students, you may choose to do the version intended for link:/problems/mario-more["more comfortable"] students instead!
