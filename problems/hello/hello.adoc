...
Be sure to register for an account at link:https://github.com/[GitHub] and then head to link:https://cs50.me/[CS50.me] to enable ``check50``! Then, go to your mailbox to accept two invitations sent to you by ``bot50``!
