...
<style>
.music {
    style="font-family: "Bravura Text";
}
</style>
...
* font_family:"Bravura text"[#&#xE1D7;#] is an eighth note, though when adjacent to one or more other eighth notes, they're often beamed, a la [music]#&#xE1F1;&#xE1F8;&#xE1F3;#;
