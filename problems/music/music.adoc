...
////
.Source: link:https://en.wikipedia.org/wiki/A440_(pitch_standard)[https://en.wikipedia.org/wiki/A440_(pitch_standard)]
...
.Chronological sequence of pictures of the compression of air molecules for a sound wave moving in the rightward direction. Source: link:https://web.stanford.edu/~zhoufan/MathematicsOfMusic.pdf[https://web.stanford.edu/~zhoufan/MathematicsOfMusic.pdf].
