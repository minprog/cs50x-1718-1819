...
14. Push the responseText of "data.json" to the div with the id "pushData". You can find this jason [here](https://niettimmeijer.github.io/Week8GO/go.html).
